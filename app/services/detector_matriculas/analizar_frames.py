...
import cv2
import numpy as np
from detector import detectar_matriculas_en_imagen
from app.services.detector_matriculas.data_loader import cargar_duenos
from app.services.detector_matriculas.enrichment import cargar_informes
